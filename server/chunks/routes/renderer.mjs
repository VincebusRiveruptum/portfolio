...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/logo_white.png"}],"style":[],"script":[],"noscript":[],"title":"Vincebus Riveruptum's portfolio"};
